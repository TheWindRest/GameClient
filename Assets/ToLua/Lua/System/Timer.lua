...
function Timer.New(func, class, duration, loop, unscaled)
	unscaled = unscaled or false and true	
	loop = loop or 1
	return setmetatable({func = func, class = class, duration = duration, time = duration, loop = loop, unscaled = unscaled, running = false}, mt)	
end
