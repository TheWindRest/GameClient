...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<UnityEngine.TextAsset>), factory.System_Action_UnityEngine_TextAsset);
		...
		DelegateTraits<System.Action<UnityEngine.TextAsset>>.Init(factory.System_Action_UnityEngine_TextAsset);
		...
		TypeTraits<System.Action<UnityEngine.TextAsset>>.Init(factory.Check_System_Action_UnityEngine_TextAsset);
		...
		StackTraits<System.Action<UnityEngine.TextAsset>>.Push = factory.Push_System_Action_UnityEngine_TextAsset;
	}
	...
	class System_Action_UnityEngine_TextAsset_Event : LuaDelegate
	{
		public System_Action_UnityEngine_TextAsset_Event(LuaFunction func) : base(func) { }
		public System_Action_UnityEngine_TextAsset_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(UnityEngine.TextAsset param0)
		{
			func.BeginPCall();
			func.Push(param0);
			func.PCall();
		...
		public void CallWithSelf(UnityEngine.TextAsset param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<UnityEngine.TextAsset> System_Action_UnityEngine_TextAsset(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<UnityEngine.TextAsset> fn = delegate(UnityEngine.TextAsset param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_UnityEngine_TextAsset_Event target = new System_Action_UnityEngine_TextAsset_Event(func);
			System.Action<UnityEngine.TextAsset> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_UnityEngine_TextAsset_Event target = new System_Action_UnityEngine_TextAsset_Event(func, self);
			System.Action<UnityEngine.TextAsset> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_UnityEngine_TextAsset(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<UnityEngine.TextAsset>), L, pos);
	}

	void Push_System_Action_UnityEngine_TextAsset(IntPtr L, System.Action<UnityEngine.TextAsset> o)
	{
		ToLua.Push(L, o);
	}
