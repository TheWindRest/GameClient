...
public class EditMapNameWindow : EditorWindow
{
    ...
    public void Start()
    {
        MapDataFilePath = Path.Combine(Application.dataPath, @"Resources\@Map");
    ...
    private void SaveMapData()
    {
        ...
        {
            MapUtils.CreateOrOpenFile(MapDataFilePath, MapUtils.GetMapFileNameById(MapFileId, level), MapData.Pop());
            level++;
        }
...
public class LoadOrCreateWindow : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        {
            var mapDataLevel1 = MapUtils.LoadFileInfo(MapDataFilePath + MapFileName + "_Level1");
            var mapDataLevel2 = MapUtils.LoadFileInfo(MapDataFilePath + MapFileName + "_Level2");
            var mapDataLevel3 = MapUtils.LoadFileInfo(MapDataFilePath + MapFileName + "_Level3");
